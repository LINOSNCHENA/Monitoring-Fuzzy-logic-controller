...
for k=1:200
z(k)=k;         
west2=N*[v((k+n1-1):(k+n2-1))'];         % DisturbanceInjecktor
east2=NS*[(d(6)*6+d(7)*3)/9 ;d(7)];      % DisturbanceMeasurering_WEIGHTING
